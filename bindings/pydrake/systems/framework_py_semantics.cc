  ...
  auto bind_common_scalar_types = [m, doc](auto dummy) {
    ...
    DefineTemplateClassWithDefault<Context<T>>(
      ...
      .def("get_mutable_continuous_state",
           ...
           py_reference_internal, doc.Context.get_mutable_continuous_state.doc)
      .def("get_continuous_state_vector",
           &Context<T>::get_continuous_state_vector,
           py_reference_internal, doc.Context.get_continuous_state_vector.doc)
      ...
      .def("get_discrete_state_vector",
           ...
           py_reference_internal, doc.Context.get_discrete_state_vector.doc)
    ...
    DefineTemplateClassWithDefault<DiagramBuilder<T>>(
      ...
      .def("Connect",
           py::overload_cast<
               ...
               &DiagramBuilder<T>::Connect), doc.DiagramBuilder.Connect.doc)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
  ...
  #pragma GCC diagnostic pop  // pop -Wdeprecated-declarations
    ...
    parameters
      .def(py::init<>(), doc.Parameters.ctor.doc)
    ...
    DefineTemplateClassWithDefault<ContinuousState<T>>(
      ...
      .def(py::init<>(), doc.ContinuousState.ctor.doc)
