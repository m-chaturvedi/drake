...
PYBIND11_MODULE(_ik_py, m) {
  ...
  py::class_<IKoptions>(m, "IKoptions", doc.IKoptions.doc)
    ...
    .def("setSequentialSeedFlag", &IKoptions::setSequentialSeedFlag, doc.IKoptions.setSequentialSeedFlag.doc)
    .def("getSequentialSeedFlag", &IKoptions::getSequentialSeedFlag, doc.IKoptions.getSequentialSeedFlag.doc)
    .def("setMajorOptimalityTolerance", &IKoptions::setMajorOptimalityTolerance, doc.IKoptions.setMajorOptimalityTolerance.doc)
    .def("getMajorOptimalityTolerance", &IKoptions::getMajorOptimalityTolerance, doc.IKoptions.getMajorOptimalityTolerance.doc)
    .def("setMajorFeasibilityTolerance",
         &IKoptions::setMajorFeasibilityTolerance, doc.IKoptions.setMajorFeasibilityTolerance.doc)
    .def("getMajorFeasibilityTolerance",
         &IKoptions::getMajorFeasibilityTolerance, doc.IKoptions.getMajorFeasibilityTolerance.doc)
    .def("setSuperbasicsLimit", &IKoptions::setSuperbasicsLimit, doc.IKoptions.setSuperbasicsLimit.doc)
    .def("getSuperbasicsLimit", &IKoptions::getSuperbasicsLimit, doc.IKoptions.getSuperbasicsLimit.doc)
    .def("setMajorIterationsLimit", &IKoptions::setMajorIterationsLimit, doc.IKoptions.setMajorIterationsLimit.doc)
    .def("getMajorIterationsLimit", &IKoptions::getMajorIterationsLimit, doc.IKoptions.getMajorIterationsLimit.doc)
    .def("setIterationsLimit", &IKoptions::setIterationsLimit, doc.IKoptions.setIterationsLimit.doc)
    .def("getIterationsLimit", &IKoptions::getIterationsLimit, doc.IKoptions.getIterationsLimit.doc)
    .def("setFixInitialState", &IKoptions::setFixInitialState, doc.IKoptions.setFixInitialState.doc)
    .def("getFixInitialState", &IKoptions::getFixInitialState, doc.IKoptions.getFixInitialState.doc)
    ...
    .def("setAdditionaltSamples", &IKoptions::setAdditionaltSamples, doc.IKoptions.setAdditionaltSamples.doc)
    .def("getAdditionaltSamples", &IKoptions::getAdditionaltSamples, doc.IKoptions.getAdditionaltSamples.doc);
