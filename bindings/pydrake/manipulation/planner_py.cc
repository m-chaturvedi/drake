  ...
  }
  {
    ...
    cls.def(py::init([](int num_positions, int num_velocities) {
        ...
        .def("set_nominal_joint_position", &Class::set_nominal_joint_position,
            doc.DifferentialInverseKinematicsParameters.set_nominal_joint_position.doc)
        .def("get_end_effector_velocity_gain",
             &Class::get_end_effector_velocity_gain,
             doc.DifferentialInverseKinematicsParameters.get_end_effector_velocity_gain.doc)
        .def("set_end_effector_velocity_gain",
             &Class::set_end_effector_velocity_gain,
             doc.DifferentialInverseKinematicsParameters.set_end_effector_velocity_gain.doc)
        .def("get_unconstrained_degrees_of_freedom_velocity_limit",
             &Class::get_unconstrained_degrees_of_freedom_velocity_limit,
             doc.DifferentialInverseKinematicsParameters.get_unconstrained_degrees_of_freedom_velocity_limit.doc)
        .def("set_unconstrained_degrees_of_freedom_velocity_limit",
             &Class::set_unconstrained_degrees_of_freedom_velocity_limit,
             doc.DifferentialInverseKinematicsParameters.set_unconstrained_degrees_of_freedom_velocity_limit.doc)
        .def("get_joint_position_limits", &Class::get_joint_position_limits,
           doc.DifferentialInverseKinematicsParameters.get_joint_position_limits.doc)
        .def("set_joint_position_limits", &Class::set_joint_position_limits,
           doc.DifferentialInverseKinematicsParameters.set_joint_position_limits.doc)
        .def("get_joint_velocity_limits", &Class::get_joint_velocity_limits,
             doc.DifferentialInverseKinematicsParameters.get_joint_velocity_limits.doc)
        .def("set_joint_velocity_limits", &Class::set_joint_velocity_limits,
            doc.DifferentialInverseKinematicsParameters.set_joint_velocity_limits.doc)
        .def("get_joint_acceleration_limits",
             &Class::get_joint_acceleration_limits,
             doc.DifferentialInverseKinematicsParameters.get_joint_acceleration_limits.doc)
        .def("set_joint_acceleration_limits",
             &Class::set_joint_acceleration_limits, 
             doc.DifferentialInverseKinematicsParameters.set_joint_acceleration_limits.doc);
  }
