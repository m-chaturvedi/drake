...
PYBIND11_MODULE(rigid_body_plant, m) {
...

  {
    ...
    cls
        ...
        .def_readwrite("v_stiction_tolerance", &Class::v_stiction_tolerance,
          D(CompliantContactModelParameters, v_stiction_tolerance))
        .def_readwrite("characteristic_radius", &Class::characteristic_radius,
          D(CompliantContactModelParameters, characteristic_radius));
...

  {
    ...
    cls
        .def("get_element_id_1", &Class::get_element_id_1, D(ContactInfo, get_element_id_1))
        .def("get_element_id_2", &Class::get_element_id_2, D(ContactInfo, get_element_id_2))
...

  {
    ...
    cls
        ...
        .def("get_reaction_force", &Class::get_reaction_force,
          D(ContactForce, get_resultant_force))
        ...
        .def("set_state_vector",
             overload_cast_explicit<
                 void, Context<T>*, const Eigen::Ref<const VectorX<T>>>(
                     &Class::set_state_vector), position,
