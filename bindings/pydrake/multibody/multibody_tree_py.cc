  ...
  // Tree.
  {
    ...
    py::class_<Class>(m, "MultibodyTree", doc.MultibodyTree.doc)
        ...
        .def("CalcMassMatrixViaInverseDynamics",
            ...
            py::arg("context"),
             doc.MultibodyTree.CalcMassMatrixViaInverseDynamics.doc)
        .def("CalcBiasTerm",
            [](const Class* self, const Context<T>& context) {
              VectorX<T> Cv;
              const int n = self->num_velocities();
...
#pragma GCC diagnostic pop  // pop -Wdeprecated-declarations
  ...
  // PointPairContactInfo
  {
    ...
    py::class_<Class>(m, "PointPairContactInfo", doc.PointPairContactInfo.doc)
      .def(py::init<BodyIndex, BodyIndex, const Vector3<T>, const Vector3<T>,
          ...
          py::arg("point_pair"), doc.PointPairContactInfo.ctor.doc)
      .def("bodyA_index", &Class::bodyA_index,
           doc.PointPairContactInfo.bodyA_index.doc)
      .def("bodyB_index", &Class::bodyB_index,
           doc.PointPairContactInfo.bodyB_index.doc)
      .def("contact_force", &Class::contact_force,
           doc.PointPairContactInfo.contact_force.doc)
      .def("contact_point", &Class::contact_point,
           doc.PointPairContactInfo.contact_point.doc)
      .def("slip_speed", &Class::slip_speed,
           doc.PointPairContactInfo.slip_speed.doc)
      .def("separation_speed", &Class::separation_speed,
           doc.PointPairContactInfo.separation_speed.doc);
  }
  ...
  // ContactResults
  {
    ...
    py::class_<Class>(m, "ContactResults")
        ...
        .def("num_contacts", &Class::num_contacts,
             doc.ContactResults.num_contacts.doc)
        .def("AddContactInfo", &Class::AddContactInfo,
          py::arg("point_pair_info"), doc.ContactResults.AddContactInfo.doc)
        .def("contact_info", &Class::contact_info, py::arg("i"),
           doc.ContactResults.contact_info.doc);
